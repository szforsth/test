...
void *send_arp_ask(void *arg)
{
	...
	unsigned char send_msg[1024] = {
		...
		0x00, 0x0c, 0x29, 0x6f, 0x42, 0xd2, //src_mac: 00:0c:29:75:a6:51
		...
		0x00, 0x0c, 0x29, 0x6f, 0x42, 0xd2,	//发送端的MAC地址
		172,  18,   0,  173,  				//发送端的IP地址
	...
	strncpy(ethreq.ifr_name, "ens34", IFNAMSIZ);	//指定网卡名称
